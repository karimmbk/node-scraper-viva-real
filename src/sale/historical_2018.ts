...
async function getAllData() {
  ...
  await writeFile(resolve('./error_pages_2018.txt'), errorPages.toString(), { encoding: 'utf-8' })
  await new ObjectsToCsv(data).toDisk('./final_2018.csv')
}
